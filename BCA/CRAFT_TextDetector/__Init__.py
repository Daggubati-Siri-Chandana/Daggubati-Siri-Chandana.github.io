...
import numpy as np
import Webapp.BCA.CRAFT_TextDetector.craft_utils
import Webapp.BCA.CRAFT_TextDetector.imgproc
import Webapp.BCA.CRAFT_TextDetector.file_utils
import json
import zipfile

from BCA.CRAFT_TextDetector.craft import CRAFT
...
parser.add_argument('--trained_model', default='/Users/daggubatisirichandana/PycharmProjects/chart_percept/Webapp/BCA/CRAFT_TextDetector/craft_mlt_25k.pth', type=str, help='pretrained model')
...
def detect_text(image):
    ...
    # load data
    for root, dirs, files in os.walk("Webapp/BCA/Deep_TextRecognition/Detected_Images/"):
        for file in files:
    ...
    for i in range(len(bboxes)):
        if(slope[i]=='_'):
            ...
            if(len(l)!=0):
                slope[i]=np.mean(l)
        ime_name="/Users/daggubatisirichandana/PycharmProjects/chart_percept/Webapp/BCA/Deep_TextRecognition/Detected_Images/"+str(i)+".png"
