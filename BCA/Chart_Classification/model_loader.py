...
def classifyImage(path):
	...
	json_file = open('/Users/daggubatisirichandana/PycharmProjects/chart_percept/Computation_and_visualization_tool/classification/model_bartype_50.json', 'r')
	loaded_model_json = json_file.read()
	json_file.close()
	loaded_model = model_from_json(loaded_model_json)

	# load weights into new model
	loaded_model.load_weights("/Users/daggubatisirichandana/PycharmProjects/chart_percept/Computation_and_visualization_tool/classification/model_bartype_50.h5")
